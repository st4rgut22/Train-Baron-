...
public class CityManager : BoardManager
{
    ...
    public static List<int[]>  boxcar_city_wait_tile = new List<int[]> { new int[] { 6, 1 }, new int[] { 13, 2 } , new int[] { 13, 3 } , new int[] { 4, 3 }, new int[] { 4, 8 }, new int[] { 12, 7 }, new int[] { 11, 9 } }; // ADD MORE 
